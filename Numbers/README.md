# Lekcja 3: Liczby
W tej lekcji poznałem podstawowe operatory arytmetyczne i ich skróconą wersję, funkcje wbudowane i moduł math.

### Podstawowe operatory arytmetyczne
W Pythonie podstawowo mamy do dyspozycji dodawanie, odejmowanie, mnożenie, dzielenie, dzielenie całkowite, resztę z dzielenia i potęgowanie. Poniżej podaję przykłady:
```Python
# Podstawowe operatory arytmetyczne
...
### Skrócone operacje arytmetyczne
Aby ułatwić i przyspieszyć swoją pracę, w Pythonie mamy do dyspozycji skróconą formę operacji arytmetycznych:
...
### Moduł math
Do naszego kodu możemy zaimportować dodatkowe rzeczy związane z matematyką na wysokim poziomie. Przydaje się to np. jak w przyszłości będę chciał zautomatyczować obliczenia do zadań z elektrotechniki lub przy większych projektach. Poniżej napisałem tylko kilka z metod, które oferuje:
